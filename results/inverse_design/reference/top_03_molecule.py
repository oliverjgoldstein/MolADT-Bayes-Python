...
random_seed = 0
predicted_freesolv = -5.15632672454
predictive_sd = 0.854178404151
target_error = 0.156326724543
bayesian_credible_score_percent = 75.501652034
score = -0.281015648728
formula = 'C9H15FO'
...
molecule = Molecule(
    atoms={
            ...
            AtomId(12): atom(12, AtomicSymbol.H, -6.906, -0.668, 5.940),
            AtomId(13): atom(13, AtomicSymbol.H, -6.189, 0.374, 4.943),
            AtomId(14): atom(14, AtomicSymbol.H, -5.392, -0.668, 5.940),
            AtomId(15): atom(15, AtomicSymbol.H, -4.432, -1.888, 4.420),
            AtomId(16): atom(16, AtomicSymbol.H, -5.567, 0.468, 2.922),
