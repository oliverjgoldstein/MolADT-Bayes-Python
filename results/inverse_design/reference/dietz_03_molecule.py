...
seed_molecule = 'water'
random_seed = 0
predicted_freesolv = -4.50930144863
predictive_sd = 0.793012143511
target_error = 0.490698551365
bayesian_credible_score_percent = 72.7708665226
score = -0.31785449601
formula = 'CH5N'
...
molecule = Molecule(
    atoms={
            ...
            AtomId(3): atom(3, AtomicSymbol.H, -0.011, 0.249, 0.721),
            AtomId(4): atom(4, AtomicSymbol.H, 0.803, 1.528, 0.202),
