...
seed_molecule = 'water'
random_seed = 0
predicted_freesolv = -5.01700613761
predictive_sd = 6.15640057471
target_error = 0.0170061376071
score = -0.217006137607
formula = 'C10H4N4'
...
local_bonds = frozenset({
    ...
    mk_edge(AtomId(1), AtomId(6)),
    mk_edge(AtomId(1), AtomId(14)),
    mk_edge(AtomId(1), AtomId(15)),
    mk_edge(AtomId(2), AtomId(3)),
    mk_edge(AtomId(2), AtomId(4)),
    mk_edge(AtomId(3), AtomId(7)),
    mk_edge(AtomId(3), AtomId(12)),
    mk_edge(AtomId(4), AtomId(5)),
    mk_edge(AtomId(4), AtomId(13)),
    mk_edge(AtomId(5), AtomId(9)),
    mk_edge(AtomId(5), AtomId(11)),
    mk_edge(AtomId(6), AtomId(7)),
    mk_edge(AtomId(6), AtomId(8)),
    mk_edge(AtomId(7), AtomId(11)),
    mk_edge(AtomId(8), AtomId(9)),
    mk_edge(AtomId(8), AtomId(10)),
    mk_edge(AtomId(8), AtomId(13)),
    mk_edge(AtomId(9), AtomId(14)),
    mk_edge(AtomId(10), AtomId(11)),
    mk_edge(AtomId(10), AtomId(12)),
    mk_edge(AtomId(10), AtomId(16)),
    mk_edge(AtomId(12), AtomId(14)),
    mk_edge(AtomId(13), AtomId(17)),
    mk_edge(AtomId(14), AtomId(18)),
})
