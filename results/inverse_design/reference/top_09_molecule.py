...
random_seed = 0
predicted_freesolv = -4.81107147707
predictive_sd = 0.960847836994
target_error = 0.188928522931
bayesian_credible_score_percent = 71.4421350399
score = -0.43628236409
formula = 'C11H15ClO'
...
molecule = Molecule(
    atoms={
            ...
            AtomId(13): atom(13, AtomicSymbol.C, -4.575, 1.413, 0.330),
            AtomId(14): atom(14, AtomicSymbol.H, -0.388, -0.593, -1.052),
            AtomId(15): atom(15, AtomicSymbol.H, -0.683, 1.007, -0.710),
            AtomId(16): atom(16, AtomicSymbol.H, -0.249, 0.025, 0.323),
            AtomId(17): atom(17, AtomicSymbol.H, -0.948, 2.325, 1.086),
            AtomId(18): atom(18, AtomicSymbol.H, -2.396, 2.301, 0.677),
    ...
    local_bonds=frozenset(
        {
                ...
                Edge(AtomId(13), AtomId(26)),
                Edge(AtomId(13), AtomId(27)),
                Edge(AtomId(13), AtomId(28)),
        }
    ),
    systems=(
            (
